...
urlpatterns = [
    ...
    path('depthead/syllabus/<str:id>',views.syllabus_semester, name='syllabus_semester'),
    path('depthead/syllabus/<str:id>/add_semester', views.add_semester, name='add_semester'),
    path('depthead/syllabus/<str:syllabus_id>/<str:semester>/views_course_list',views.view_course_list_all, name='view_course_list'),
    path('depthead/syllabus/<str:syllabus_id>/<str:semester>/add_course',views.add_course, name='add_course'),
