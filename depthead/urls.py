...
urlpatterns = [
    ...
    path('depthead/syllabus/<str:syllabus_id>',
         views.syllabus_semester, name='syllabus_semester'),
    ...
    path('depthead/batch_info/<str:batch>/',
         views.batch_info, name='batch_info'),
    path('depthead/batch_info/<str:batch>/<str:semester>/result_info',
         views.result_info, name='result_info'),
    #path('results/<str:Dy_id>',views.batch_results, name='batch_results'),
